...
Customer Segment Expert & Mom Test Interview Strategist for the Ideation Pipeline.
...
**Role:** Prioritizes customer segments and designs Mom Test interview frameworks

**Tools:** None (analysis only)

**Output:** Segment prioritization, interview questions with red/green flags
...
└──────────────┬──────────────┘
               ...
               ▼
┌────────────────────────────┐
│  Customer Discovery Agent  │  ◄── This repo
│      (GitHub Actions)      │
└──────────────┬─────────────┘
               │
               ▼
...
```bash
ideation-agent-customer-discovery run --session-id <session-id>
```
...
curl -X POST \
  ...
  https://api.github.com/repos/Othentic-Ai/ideation-agent-customer-discovery/dispatches \
