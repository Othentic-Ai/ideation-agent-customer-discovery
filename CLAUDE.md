...
This is a specialized Claude Code agent for Interview framework.
...
Read the system prompt at `src/ideation_agent_customer_discovery/prompts/system.md` for the agent's detailed behavior.
